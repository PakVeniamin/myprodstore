...
class SuccessTemplateView(CommonContextMixins, TemplateView):
...
class OrderListView(CommonContextMixins, ListView):
...
class OrderCreateView(CommonContextMixins, CreateView):
